...
<h1>4. Production Deployment</h1>
<ul>
<li>Use <code>Backend/.env.example</code> and <code>frontend/.env.example</code> as templates for your real secrets.</li>
<li>Run <code>npm --prefix frontend run build</code> to build the frontend before deployment.</li>
<li>Start the backend with <code>npm --prefix Backend start</code> or a process manager like PM2.</li>
<li>Deploy the backend with a persistent uploads/storage strategy — local disk is not durable on most cloud hosts.</li>
</ul>